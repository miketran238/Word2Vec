...
public class ColoredScatterPlot extends ScatterPlot {
	...
	public ColoredScatterPlot(String n, double[][] _XY, String [] classes, String[] labels) {
		super(n, AbstractDrawer.DEFAULT_COLOR, AbstractDrawer.CROSS_DOT, AbstractDrawer.DEFAULT_DOT_RADIUS, _XY);
		this.classes = classes;
		this.labels = labels;
	}
	...
	public void plot(AbstractDrawer draw, Color col) {
        ...
        final Font DEFAULT_FONT = new Font("Arial", Font.PLAIN, 15);
